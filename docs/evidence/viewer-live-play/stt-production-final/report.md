...
Production input: 16000 Hz, minimum 17600 samples, then 8000 zero samples on each side (500 ms). Capture timestamps and VAD boundaries are unchanged. Unsuffixed configurations use this production preparation exactly once; experimental suffixes add context beyond it.
...
| Config | Load s | +RAM MiB | +GPU MiB | Mean latency s | p90 s | RTF | CER | WER | Content recall | Invented words | Act match |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| turbo-q5_0-ru-gpu-beam | 0.75 | 1944 | 1017 | 0.17 | 0.19 | 0.05 | 0.16 | 0.13 | 0.89 | 13 | 22/25 |
...
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Всем привет, парни! Как дела? Как настроение? Что сегодня делали? | ru | 0.00 | 1.00 | Greeting, QuestionToChat, PersonalQuestion | 0.20 |

### 2. «Привет, привет, дорогой друг. Как вы вообще? Расскажите, что думаете.» (6.7 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | привет привет дорогой друг как вообще расскажите что думаете | ru | 0.05 | 1.00 | Greeting, QuestionToChat, OpinionRequest | 0.19 |

### 3. «Вы можете мне хоть что-то ответить?» (3.2 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Вы можете мне хоть что-то ответить? | ru | 0.00 | 1.00 | QuestionToChat | 0.17 |
...
| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | А ты во что сегодня играл? | ru | 0.00 | 1.00 | QuestionToViewer, PersonalQuestion | 0.16 |

### 6. «Чат, во что сегодня поиграем?» (3.8 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Чат, во что сегодня поиграем? | ru | 0.00 | 1.00 | QuestionToChat, GameplayQuestion | 0.17 |

### 7. «Ребят, как вам звук сегодня, нормально слышно?» (3.6 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Ребят, как вам звук сегодня? Нормально слышно? | ru | 0.00 | 1.00 | QuestionToChat, OpinionRequest | 0.20 |

### 8. «Жесть. Устал, наверное?» (3.3 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Жесть. Устал, наверное. | ru | 0.00 | 1.00 | Statement (ref QuestionToChat, PersonalQuestion) | 0.16 |

### 9. «Сегодня просто болтаем, никуда не торопимся.» (3.9 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Сегодня просто болтаем, никуда не торопимся. | ru | 0.00 | 1.00 | Statement | 0.18 |

### 10. «Блин, опять всё зависло, капец.» (3.4 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Блин, опять все зависло. Капец. | ru | 0.00 | 1.00 | Statement | 0.18 |
...
| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Мика, ты тут? Как ты? | ru | 0.00 | 1.00 | QuestionToViewer, PersonalQuestion | 0.17 |

### 16. «Найт Оул, опять ночная смена?» (3.1 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Найт Волл, опять ночная смена | ru | 0.07 | 0.80 | Statement (ref QuestionToChat) | 0.16 |

### 17. «А вы откуда вообще, ребят?» (2.3 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | А вы откуда вообще, ребят? | ru | 0.00 | 1.00 | QuestionToChat | 0.16 |
...
| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Ладно. | ru | 0.44 | 0.50 | Filler | 0.15 |

### 24. «Hello chat, how are you doing today?» (3.8 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Привет, чат! Как дела сегодня? | ru | 0.91 | 0.00 | Greeting, QuestionToChat, PersonalQuestion | 0.16 |

### 25. «Хай, hello, how are you?» (4.7 s)

| Config | Transcript | Lang | CER | Recall | Acts | s |
|---|---|---|---:|---:|---|---:|
| turbo-q5_0-ru-gpu-beam | Здравствуйте! Здравствуйте! Здравствуйте! Как ты себя чувствуешь? | ru | 2.62 | 0.00 | Greeting, QuestionToViewer, PersonalQuestion (ref Greeting, QuestionToChat, PersonalQuestion) | 0.19 |
