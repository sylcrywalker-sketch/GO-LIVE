...
namespace GoLive.Viewers
{
    ...
    public sealed class ViewerPersona
    {
        ...
        // Enforced by the output validator, not only asked for.
        public Profanity Profanity { get; }
        // The authored profile behind a permanent viewer (per-message habits); null for anonymous chatters.
        ...
        public ViewerPersona(ViewerLanguage language, string personality, string style, int minimumWords, int maximumWords,
            Profanity profanity = Profanity.Mild, ViewerProfile profile = null)
        {
        ...
        internal static readonly (string personality, string style, int min, int max)[] Anonymous =
        {
            ...
            ("A viewer who jokes around and teases a little, never mean.",
                "Short: 2-8 words. Lowercase. Laughs like real chat (ахах / лол / lmao) only when something is funny. No emoji.", 2, 8),
