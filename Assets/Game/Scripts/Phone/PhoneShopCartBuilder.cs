...
namespace GoLive.Editor.Phone
{
    public static class PhoneShopCartBuilder
    {
            ...
            PhoneShopView shopView)
        {
            ...
            ScrollRect orderList =
                GetReference<ScrollRect>(
                    shop,
                    "_orderList");

            ShopOrderRowView currentOrderTemplate =
                GetReference<ShopOrderRowView>(
                    shop,
                    "_orderRowTemplate");
            ...
            if (ordersButton == null ||
                ...
                card == null ||
                orderList == null ||
                orderList.content == null ||
                currentOrderTemplate == null)
            {
                throw new InvalidOperationException(
                    "The existing Shop wiring is incomplete. Orders button, Orders label, ProductCardTemplate, OrderList and OrderRowTemplate are required before migration.");
            }
            ...
            ShopOrderRowView orderTemplate =
                RebuildOrderRowTemplate(
                    orderList,
        ...
        private static ShopOrderRowView RebuildOrderRowTemplate(
            ScrollRect orderList,
            ShopOrderRowView currentTemplate,
            TMP_FontAsset font,
            Sprite roundedSprite)
        {
            RectTransform content =
            ...
            {
                throw new InvalidOperationException(
                    "Orders ScrollRect has no Content.");
            }
            ...
            if (currentTemplate != null)
            {
                ...
                if (currentTemplate.gameObject.name ==
                    "OrderRowTemplate")
                {
                    currentTemplate.gameObject.name =
                        "OrderRowTemplate_Legacy_Disabled";
                }
            }
            ...
            thumbLayout.minWidth = 76f;
            thumbLayout.minHeight = 76f;
            thumbLayout.preferredWidth = 76f;
            thumbLayout.preferredHeight = 76f;
            ...
            infoLayout.minHeight = 94f;
            infoLayout.preferredHeight = 94f;
            infoLayout.flexibleWidth = 1f;
            ...
            ShopOrderRowView view =
                row.gameObject.AddComponent<ShopOrderRowView>();
